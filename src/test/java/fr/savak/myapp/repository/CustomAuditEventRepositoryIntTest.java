package fr.savak.myapp.repository;

import fr.savak.myapp.MyappApp;
import fr.savak.myapp.config.Constants;
import fr.savak.myapp.config.audit.AuditEventConverter;
import fr.savak.myapp.domain.PersistentAuditEvent;
...
import static fr.savak.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
